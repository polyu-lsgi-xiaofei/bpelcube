 ...
 *
 */
public class HypercubeNodeApp extends HypercubeNode {
	 ...
	 * @param logLevel
	 */
	public HypercubeNodeApp(URI home, String name, String domain, int port,
			Level logLevel) {
	 ...
	 * @param logLevel
	 */
	public HypercubeNodeApp(URI home, String name, String domain, URI address,
	...
	protected void prepareGUI() {
		...
		mainFrame.setTitle("Hypercube:node " + this.getName());
	...
	public static void main(String[] args) throws Exception {
		...
		HypercubeNodeApp app = new HypercubeNodeApp(homeURI, name, domain, 
